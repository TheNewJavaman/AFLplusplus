...
static char *afl_environment_variables[] = {
    ...
    "AFL_COQUI_BATCH_SIZE", "AFL_COQUI_CUBIN", "AFL_COQUI_DEVICE",
    "AFL_COQUI_GPU_MUTATE", "AFL_COQUI_GPU_MUTATE_STEPS",
    "AFL_COQUI_HEAP_SIZE", "AFL_COQUI_MAX_INPUT_SIZE",
    "AFL_COQUI_SLAB_SIZE", "AFL_COQUI_STACK_SIZE",
    "AFL_COQUI_THREAD_BUDGET_US",
    "AFL_COQUI_TIMEOUT_GRACE_US", "AFL_COQUI_TIMEOUT_US",
    "AFL_CRASH_EXITCODE",
