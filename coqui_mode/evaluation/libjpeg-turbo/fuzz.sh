#!/usr/bin/env bash
# fuzz.sh — prep the coqui mode libjpeg-turbo fuzz workspace + print suggested
...
CUBIN="${SCRIPT_DIR}/libjpeg_turbo_decompress_fuzzer.cubin"
CPU_BIN="${SCRIPT_DIR}/libjpeg_turbo_decompress_fuzzer_cpu"
...
echo "==============================================================="
echo "  coqui mode libjpeg-turbo fuzz workspace ready"
echo "  cubin:  $CUBIN"
echo "  cpu:    $CPU_BIN"
