#!/usr/bin/env bash
# fuzz.sh — prep the coqui mode stb_image fuzz workspace + print suggested
...
CUBIN="${SCRIPT_DIR}/stb_image_read_fuzzer.cubin"
CPU_BIN="${SCRIPT_DIR}/stb_image_read_fuzzer_cpu"
...
echo "==============================================================="
echo "  coqui mode stb_image fuzz workspace ready"
echo "  cubin:  $CUBIN"
echo "  cpu:    $CPU_BIN"
