#!/usr/bin/env bash
# fuzz.sh — prep the coqui mode libxml2 fuzz workspace + print suggested
...
CUBIN="${SCRIPT_DIR}/libxml2_xml_read_fuzzer.cubin"
CPU_BIN="${SCRIPT_DIR}/libxml2_xml_read_fuzzer_cpu"
...
echo "==============================================================="
echo "  coqui mode libxml2 fuzz workspace ready"
echo "  cubin:  $CUBIN"
echo "  cpu:    $CPU_BIN"
