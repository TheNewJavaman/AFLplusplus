#!/usr/bin/env bash
# fuzz.sh — prep the coqui mode libyaml fuzz workspace + print suggested
...
CUBIN="${SCRIPT_DIR}/libyaml_parser_fuzzer.cubin"
CPU_BIN="${SCRIPT_DIR}/libyaml_parser_fuzzer_cpu"
...
echo "==============================================================="
echo "  coqui mode libyaml fuzz workspace ready"
echo "  cubin:  $CUBIN"
echo "  cpu:    $CPU_BIN"
