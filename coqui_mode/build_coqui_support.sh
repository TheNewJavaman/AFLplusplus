...
for f in coqui_runtime coqui_coverage coqui_memory coqui_asan coqui_ubsan coqui_libc coqui_printf coqui_complex coqui_slab coqui_stack_spill coqui_trace coqui_global_init coqui_mutate; do
...
llvm-link "$COQUI_DIR/runtime/build/coqui_runtime.bc" \
          ...
          "$COQUI_DIR/runtime/build/coqui_ubsan.bc" \
          "$COQUI_DIR/runtime/build/coqui_libc.bc" \
          "$COQUI_DIR/runtime/build/coqui_printf.bc" \
          "$COQUI_DIR/runtime/build/coqui_complex.bc" \
          "$COQUI_DIR/runtime/build/coqui_slab.bc" \
          "$COQUI_DIR/runtime/build/coqui_stack_spill.bc" \
          "$COQUI_DIR/runtime/build/coqui_trace.bc" \
          "$COQUI_DIR/runtime/build/coqui_global_init.bc" \
