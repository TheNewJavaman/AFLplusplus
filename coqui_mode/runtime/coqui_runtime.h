...
/* GPU-side mutation (Phase 2+3).  When __coqui_gpu_mutate_enabled != 0,
 * applies __coqui_mutate_steps rounds of AFL havoc mutation to the
 * per-thread input buffer before calling the harness. */
